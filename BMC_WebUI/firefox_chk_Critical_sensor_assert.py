...
#os.system(ipmicmd + " sensor thresh Temp_CPU0 upper 20 25 30")

while True:
	ipmicmd="ipmitool -I lanplus -H " + ip + " -U " + user + " -P " +  password + " "
	os.system(ipmicmd + " sensor thresh Volt_P12V upper 10 10.5 11")
	#driver.refresh()
	time.sleep(1)
	...
	critical_sensor = driver.find_element_by_css_selector('div.animated:nth-child(2) > div:nth-child(1)').text
	print (critical_sensor)
	print("")			
	if "Volt_P12V" in critical_sensor:
						break
	#print (critical_sensor)
	#print("")
	#break
