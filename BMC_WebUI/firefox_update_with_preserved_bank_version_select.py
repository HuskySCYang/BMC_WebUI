...
driver.get(url)  
test = WebDriverWait(driver,30,1).until(lambda test : driver.find_element_by_id('userid'), message='wait fail')
#time.sleep(10)
...
##upload image
##
update_image="/var/www/html/"+bmc_image
print (update_image)
try:
...
#Image 1
print ("Bank select:" bank)
bank.select_by_value(bank)
...
WebDriverWait(driver,480,1).until(EC.alert_is_present())
alert_info=driver.switch_to.alert.text
print (alert_info)
alert = driver.switch_to.alert
alert.accept()
