...
print ("step_2: delete user #8")

link = driver.find_element_by_css_selector('.col-md-12 > div:nth-child(9) > div:nth-child(1) > div:nth-child(1) > a:nth-child(1) > i:nth-child(1)')
link.click()
time.sleep(5)
