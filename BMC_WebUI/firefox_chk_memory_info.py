...
link = driver.find_element_by_css_selector('#memory-tab')
link.click()

time.sleep(5)
print ("step_2: capature the information of Memory")


try:
	Memory_info = driver.find_element_by_css_selector('.tab-content').text
	print (Memory_info)
	time.sleep(1)
	...
	Memory_info = driver.find_element_by_css_selector('#memory > div:nth-child(1)').text
	print (Memory_info)
	time.sleep(1)
