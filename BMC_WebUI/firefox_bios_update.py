...
for line in gui.readlines():
	result=line.find("biosimage_new")
	if result != -1:
		#image=line[13:37]
		image = line.split("=")[1]
...
#section_options
time.sleep(2)
wait_upload = WebDriverWait(driver,70,1).until(lambda wait_upload : driver.find_element_by_id('section_options'), message='upload bios image fail')
time.sleep(5)
#start
#start
time.sleep(5)
#print ("Click the 'start' to update BIOS")
link = driver.find_element_by_css_selector('#start')
link.click()
print ("")
print ("")
