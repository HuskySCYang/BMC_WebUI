...
try:
	link = driver.find_element_by_xpath("//*[contains(text(), 'FRU Information')]")
	link.click()
...
tbl_chassis_info_string = driver.find_element_by_id('tbl_chassis_info').text
print (tbl_chassis_info_string )
tbl_board_info_string = driver.find_element_by_id('tbl_board_info').text
print (tbl_board_info_string )
tbl_product_info_string = driver.find_element_by_id('tbl_product_info').text
print (tbl_product_info_string )
