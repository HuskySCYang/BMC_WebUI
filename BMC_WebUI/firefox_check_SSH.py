...
print ("step_1: enter Services ")

link = driver.find_element_by_css_selector('div.col-md-3:nth-child(17) > a:nth-child(1) > span:nth-child(2)')
link.click()

time.sleep(5)
print ("step_2: Get Service information ")

service_info = driver.find_element_by_css_selector('.table-list').text
print (service_info)
