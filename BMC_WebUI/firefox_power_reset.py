...
try:
	link = driver.find_element_by_css_selector('.sidebar-menu > li:nth-child(11) > a:nth-child(1) > span:nth-child(2)')
	link.click()
...
print (" ")
print ("Action: Hard Reset")
print (" ")

#.checked > ins:nth-child(2)

try:
	link = driver.find_element_by_css_selector('div.form-group:nth-child(4) > label:nth-child(1) > div:nth-child(1) > ins:nth-child(2)')
	link.click()
