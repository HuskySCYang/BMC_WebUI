...
print (" ")
print ("Step_3: Enable Automatic NTP Date & Time ")
print (" ")

try:
	link = driver.find_element_by_css_selector('#idrwauto_date_ntp > label:nth-child(2) > div:nth-child(1) > ins:nth-child(2)')
	link.click()
	
	
except:
	title = driver.find_element_by_css_selector('#idrwauto_date_ntp > label:nth-child(2) > div:nth-child(1) > ins:nth-child(2)')
	title.click()
