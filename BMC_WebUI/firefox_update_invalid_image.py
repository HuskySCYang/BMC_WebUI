...
for line in gui.readlines():
	result=line.find("invalid_bmcimage")
	if result != -1:
		#image=line[13:37]
		image = line.split("=")[1]
...
##confirm update
##
WebDriverWait(driver,120,1).until(EC.alert_is_present())
...
time.sleep(60)
while True:
	update_info_2 = driver.find_element_by_css_selector('#firmware_update_desc').text
	print (update_info_2)	
	print ("")
	print ("")
	with open ("temp_1.log","w") as gui:
		gui.write(update_info_2)
		gui.write("\n")
	...
	print ("")
	print ("")
	with open ("temp_1.log","r") as gui:
		content=gui.read()
		result=content.find("Current Image Version")
		#print (result)
		if result == -1: 
...
##
##upload invalid image to BMC done 
##
try:
	print ("")
	print ("")
