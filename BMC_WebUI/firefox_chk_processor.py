...
link = driver.find_element_by_css_selector('#processor-tab')
link.click()

time.sleep(5)
print ("step_2: capature the information of Processor")


try:
	Processor_info = driver.find_element_by_css_selector('.tab-content').text
	...
	Processor_info = driver.find_element_by_css_selector('#processor > div:nth-child(1)').text
	print (Processor_info)
	time.sleep(1)
