...
print ("step_1: >> baseboard")

link = driver.find_element_by_css_selector('#baseboard-tab')
link.click()

time.sleep(5)
print ("step_2: capature the information of baseboard")


try:
	baseboard_info = driver.find_element_by_css_selector('.content').text
	...
	baseboard_info = driver.find_element_by_css_selector('.tab-content').text
	print (baseboard_info)
	time.sleep(1)
...
try:
	enable_debug_interface = driver.find_element_by_css_selector('#disable_debug_interface')
	enable_debug_interface.click()
	time.sleep(1)
