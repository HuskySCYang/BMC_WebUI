...
print ("step_1: >> Processor")

link = driver.find_element_by_css_selector('#pciedevice-tab')
link.click()

time.sleep(5)
print ("step_2: capature the information of Pciedevice Page-1")


try:
	Pciedevice_info_1 = driver.find_element_by_css_selector('.tab-content').text
	print (Pciedevice_info_1)
	time.sleep(1)
	...
	Pciedevice_info_1 = driver.find_element_by_css_selector('#pciedeviceinfo').text
	print (Pciedevice_info_1)
	time.sleep(1)


print ("step_3: capature the information of Pciedevice Page-2")



try:
	Pciedevice_info_2 = driver.find_element_by_css_selector('li.footable-page:nth-child(4) > a:nth-child(1)')
	Pciedevice_info_2.click()
	time.sleep(2)
...
try:
	Pciedevice_info_2 = driver.find_element_by_css_selector('.tab-content').text
	print (Pciedevice_info_2)
	time.sleep(1)
	...
	Pciedevice_info_2 = driver.find_element_by_css_selector('#pciedeviceinfo').text
	print (Pciedevice_info_2)
	time.sleep(1)


print ("step_4: capature the information of Pciedevice Page-3")



try:
	Pciedevice_info_3 = driver.find_element_by_css_selector('li.footable-page:nth-child(5) > a:nth-child(1)')
	Pciedevice_info_3.click()
	time.sleep(2)
...
try:
	Pciedevice_info_3 = driver.find_element_by_css_selector('.tab-content').text
	print (Pciedevice_info_3)
	time.sleep(1)
	...
	Pciedevice_info_3 = driver.find_element_by_css_selector('#pciedeviceinfo').text
	print (Pciedevice_info_3)
	time.sleep(1)
...
time.sleep(1)
refresh = driver.find_element_by_css_selector('#refreshPage > span:nth-child(2)')
refresh.click()
time.sleep(5)

print ("step_5: >> PCIefunction")

link = driver.find_element_by_css_selector('#pciefunction-tab')
link.click()

time.sleep(5)
print ("step_6: capature the information of PCIefunction Page-1")
...
print ("step_7: capature the information of PCIefunction Page-2")
...
print ("step_8: capature the information of PCIefunction Page-3")
...
print ("step_9: capature the information of PCIefunction Page-4")
